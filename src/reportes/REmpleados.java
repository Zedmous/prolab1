...
public class REmpleados extends javax.swing.JDialog {

    public REmpleados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableConsultaVigilante = new javax.swing.JTable();
        jPanel3 = new javax.swing.JPanel();
        jPanel4 = new javax.swing.JPanel();
        rdcodigo = new javax.swing.JRadioButton();
        rdnombre = new javax.swing.JRadioButton();
        rdexistenciaMm = new javax.swing.JRadioButton();
        rdexistenciamM = new javax.swing.JRadioButton();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2), "LISTADO DE EMPLEADOS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        jPanel2.setLayout(null);

        jTableConsultaVigilante.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Cedula", "Nombre", "Apellido", "Sexo", "Fecha Ingreso", "Telefono"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jTableConsultaVigilante);
        ...
        rdcodigo.setText("Cedula");
        rdcodigo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdcodigoActionPerformed(evt);
            }
        });
        jPanel3.add(rdcodigo);
        rdcodigo.setBounds(20, 30, 90, 23);

        rdnombre.setText("Nombre");
        jPanel3.add(rdnombre);
        rdnombre.setBounds(90, 30, 80, 23);

        rdexistenciaMm.setText("Sexo");
        jPanel3.add(rdexistenciaMm);
        rdexistenciaMm.setBounds(380, 30, 140, 23);

        rdexistenciamM.setText("Apellido");
        jPanel3.add(rdexistenciamM);
        rdexistenciamM.setBounds(180, 30, 100, 23);
        ...
        btnseleccionar.setBounds(30, 20, 150, 30);
        ...
        txtbsuqueda.setBounds(90, 30, 280, 30);

        btnbuscar.setText("Busqueda");
        jPanel7.add(btnbuscar);
        btnbuscar.setBounds(380, 30, 130, 30);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                REmpleados dialog = new REmpleados(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableConsultaVigilante;
    private javax.swing.JRadioButton rdcodigo;
    private javax.swing.JRadioButton rdexistenciaMm;
    private javax.swing.JRadioButton rdexistenciamM;
