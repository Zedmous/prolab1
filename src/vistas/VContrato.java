...
import controladores.CContrato;
import java.awt.event.ActionListener;


public class VContrato extends javax.swing.JDialog {
    private CContrato cont;
    public VContrato(java.awt.Frame parent, boolean modal,CContrato cont) {
        super(parent, modal);
        initComponents();
        this.cont=cont;
    }
    ...
    public void sinregistro(){
        ...
        txtcantidadcs.setEditable(false);
        txtsubtotal.setEditable(false);
        txtsubtotaliva.setEditable(false);
        txttotal.setEditable(false);
        
        rdtc12.setEnabled(false);
        rdtc24.setEnabled(false);
        ...
        txtcodigos.setText("");
        txtnombres.setText("");
        txtcantidadcs.setText("");
        txtsubtotal.setText("");
        txtsubtotaliva.setText("");
        txttotal.setText("");
        
        rdtc12.setSelected(false);
        rdtc24.setSelected(false);
    }
    ...
    public void removerCliente(){
        ...
        removerServicio();
        btnconsultars.setEnabled(false);
        txtcodigos.setEditable(false);
        txtrif.setText("");
        txtnombrecli.setText("");
    ...
    public void encontradoServicio(){
        ...
        txtcodigos.setEditable(false);
        txtnombres.setEditable(false);
        txtcantidadcs.setEditable(true);
        btncancelars.setEnabled(true);
    }
    ...
    private void initComponents() {
        ...
        rdtc24 = new javax.swing.JRadioButton();
        rdtc12 = new javax.swing.JRadioButton();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Contrato", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        ...
        jPanel2.add(txtnumeroc);
        txtnumeroc.setBounds(110, 30, 150, 30);
        ...
        jPanel3.add(txtrif);
        txtrif.setBounds(60, 20, 160, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setText("Rif:");
        jPanel3.add(jLabel4);
        jLabel4.setBounds(20, 20, 30, 30);
        jPanel3.add(txtnombrecli);
        txtnombrecli.setBounds(430, 20, 180, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setText("Nombre:");
        jPanel3.add(jLabel6);
        jLabel6.setBounds(370, 20, 51, 30);

        btnremover.setText("Remover");
        jPanel3.add(btnremover);
        btnremover.setBounds(620, 20, 100, 30);

        btnverificar.setText("Verificar");
        jPanel3.add(btnverificar);
        btnverificar.setBounds(230, 20, 120, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(20, 130, 730, 70);

        jPanel4.setBackground(new java.awt.Color(153, 204, 255));
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Detalle del Contrato", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jLabel17.setText("Cantidad Contratada:");
        ...
        jPanel2.add(jPanel8);
        jPanel8.setBounds(20, 210, 730, 140);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setText("Fecha Desde:");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 90, 30);
        jPanel2.add(txtfechad);
        txtfechad.setBounds(110, 90, 150, 30);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("Fecha Hasta:");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(270, 90, 90, 30);
        jPanel2.add(txtfechah);
        txtfechah.setBounds(370, 90, 160, 30);

        rdtc24.setText("24Hrs");
        jPanel2.add(rdtc24);
        rdtc24.setBounds(693, 90, 60, 30);

        rdtc12.setText("12Hrs");
        jPanel2.add(rdtc12);
        rdtc12.setBounds(610, 90, 70, 30);
        ...
        btnbuscar.setBounds(10, 90, 130, 40);
        ...
        txtbuscar.setBounds(10, 50, 130, 30);

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel11.setText("N° Contrato:");
        jPanel6.add(jLabel11);
        jLabel11.setBounds(40, 20, 80, 20);

        jPanel5.add(jPanel6);
        jPanel6.setBounds(10, 130, 170, 150);
        ...
        btnsalir.setBounds(10, 260, 130, 40);

        btngenerar.setText("Nuevo Contrato");
        jPanel7.add(btngenerar);
        btngenerar.setBounds(10, 40, 130, 40);

        btncancelar.setText("Cancelar");
        jPanel7.add(btncancelar);
        btncancelar.setBounds(10, 210, 130, 40);

        btnimprimir.setText("Imprimir");
        jPanel7.add(btnimprimir);
        btnimprimir.setBounds(10, 150, 130, 40);

        btnregistrar.setText("Registrar");
        jPanel7.add(btnregistrar);
        btnregistrar.setBounds(10, 100, 130, 40);

        jPanel5.add(jPanel7);
        jPanel7.setBounds(10, 290, 170, 310);
    ...
    private javax.swing.JRadioButton rdtc12;
    private javax.swing.JRadioButton rdtc24;
     ...
     * @return the rdtc12
     */
    public javax.swing.JRadioButton getRdtc12() {
        return rdtc12;
    }

    /**
     * @param rdtc12 the rdtc12 to set
     */
    public void setRdtc12(javax.swing.JRadioButton rdtc12) {
        this.rdtc12 = rdtc12;
    }
     ...
     * @return the rdtc24
     */
    public javax.swing.JRadioButton getRdtc24() {
        return rdtc24;
    }

    /**
     * @param rdtc24 the rdtc24 to set
     */
    public void setRdtc24(javax.swing.JRadioButton rdtc24) {
        this.rdtc24 = rdtc24;
    }
