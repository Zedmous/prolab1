...
import controladores.CCargo;
import java.awt.event.ActionListener;


public class VCargo extends javax.swing.JDialog {
    private CCargo ccarg;
    public VCargo(java.awt.Frame parent, boolean modal,CCargo ccarg) {
        super(parent, modal);
        initComponents();
        this.ccarg=ccarg;
    }
   ...
   public void agregarListener(ActionListener accion) {
    ...
    private void initComponents() {
        ...
        txtsueldom.setBounds(120, 150, 220, 30);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VCargo dialog = new VCargo(new javax.swing.JFrame(), true);
